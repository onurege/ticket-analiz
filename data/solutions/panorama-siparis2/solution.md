...
**Menü Adımı:** `Satış ve Alış İşlemleri → Satış İşlemleri → Sipariş`

## Ekran Tanımı

Alınan siparişler bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Satış Siparişleri listelenir.
...
| Sipariş Neden Giriş | Rehberde sipariş nedenleri listelenir ve bilgi amaçlı giriş yapılır zorunlu bir alan değildir. |
...
| Müşteri Sip. No | Müşteri Sipariş No değerinin girilebileceği Text alandır. |
...
| Satış Tipi | Toptan Satış mı Parakende satış mı bilgisinin tutulduğu alandır. |
