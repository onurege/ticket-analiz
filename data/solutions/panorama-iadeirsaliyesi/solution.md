...
**Menü Adımı:** `Satış ve Alış İşlemleri → Satıcıya İade İşlemleri → İade İrsaliye`

## Ekran Tanımı

Satıcıya İade İrsaliyeleri bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Satıcıya İade İrsaliyeleri listelenir.
...
| Satış Temsilcisi | İade İrsaliyenin hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Satıcıya İade İrsaliyesi için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| İade Nedeni | Satıcıya İade İrsaliyesinin İade nedeni seçilir. Parametrik olarak başlıkta ya da detayda sorulur. |
...
| Giriş Tipi | Satıcıya İade İrsaliyenin nereden girilmiş olduğunu belirtir. Panoramadan girilen Satıcıya İade İrsaliyeleri için giriş tipi EnroutePanorama, Mobilden girilen irsaliyelerde giriş tipi PanoramaMobile, Ticari Paket aktarımı ile gelen irsaliyelerde giriş tipi Panorama Aktarım olarak görünür. |
| Belge Durumu | Satıcıya İade İrsaliyesinin durumunun ne olduğunu gösterir. Aktif, Pasif, İptal, Bloke, Silindi değerlerini alır. |
| Basım Durumu | Satıcıya İade İrsaliyesi kaydedildiğinde basım durumu yazdırılmadı olarak görünür. Belge yazdırdıktan sonra basım durumu yazdırıldı olarak güncellenir. |
| Aktarım Durumu | Satıcıya İade İrsaliyesinin Ticari pakete aktarılıp aktarılmadığı bilgisini gösterir. Ticari pakete aktarılmamış Satıcıya İade irsaliyesinin aktarım durumu Aktarılmadı, Ticari Pakete aktarılmış Satıcıya İade irsaliyesinin aktarım durumu Aktarıldı olarak görünür. |
| Onay Durumu | Eğer Satıcıya İade İrsaliyesi için iş akış tanımı var ise Satıcıya İade İrsaliyesi kaydedildiğinde onay durumu onaylanmadı olarak görünür. Bu Satıcıya İade İrsaliyesinin İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Satıcıya İade İrsaliyesi ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
| Oluşturulma Yeri | Satıcıya İade İrsaliyenin hangi menüden oluşturulduğunun bilgisinin gösterildiği alandır. |
| Oluşturulma Tarihi | Satıcıya İade İrsaliyenin hangi tarih ve hangi saatte oluşturulduğunun gösterildiği alandır. |
| Fatura Takip Kodu | İlgili Satıcıya İade İrsaliyesine bağlı Satıcıya İade faturası var ise bağlı faturanın belge kodu değeri görünür. |
| Sipariş Takip Kodu | İlgili Satıcıya İade İrsaliyesi bir Satıcıya İade siparişine bağlı ise bağlı olan Siparişin belge kodu değeri görünür. |
