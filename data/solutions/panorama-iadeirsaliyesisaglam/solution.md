# İade Irsaliyesi (Sağlam)

_Kaynak: Panorama Kullanım Kılavuzu_

**Menü Adımı:** `Satış ve Alış İşlemleri → Müşteriden İade İşlemleri → İade İrsaliyesi (Sağlam)`

## Ekran Tanımı

Müşteriden İade İrsaliyeleri (Sağlam) bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Müşteriden İade İrsaliyeleri (Sağlam) listelenir.
...
| Satış Temsilcisi | Müşteriden İade İrsaliyeleri (Sağlam) hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Müşteriden İade İrsaliyesi (Sağlam) için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
| Depo Kodu | İade alınan ürünün hangi depoya alınacağı bu alandan seçilir. Default olarak distribütörün varsayılan deposu gelir fakat değiştirilebilir. Zorunlu bir alandır. |
...
| Sevk Tarihi | Belgenin sevk tarihi bilgisi girilir. |
...
| İade Nedeni | Belge detayındaki ürünlerin tamamı için iade nedeninin seçileceği alandır. Parametrik olarak başlıkta veya detayda iade neden seçimi zorunlu hale gelir. |
...
| Depo Mik. | Ürünün belge başlığında seçilen depodaki mevcut stok miktarıdır. Stok miktarı ana birim bazında görüntülenir ancak ekrandaki birim alanından 1.birim yerine 2.birim / 3.birim / 4.birim / 5.birim gibi birimler seçildiğinde depo miktarı bu birime göre gösterilecektir. |
...
| İade Nedeni | Ürün için seçilmiş olan iade nedeni görünür. |
...
| Onay Durumu | Eğer Müşteriden İade İrsaliyesi (Sağlam) için iş akış tanımı var ise Müşteriden İade İrsaliyesi (Sağlam) kaydedildiğinde onay durumu onaylanmadı olarak görünür. Kaydetmiş olduğumuz Müşteriden İade İrsaliyesi (Sağlam) İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Müşteriden İade İrsaliyesi (Sağlam) ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
...
| Sipariş Takip Kodu | Müşteriden İade İrsaliyesi (Sağlam) herhangi bir siparişe bağlı olarak oluşmaz bu nedenden dolayı Müşteriden İade İrsaliyesi (Sağlam) belgelerinde bu alanda herhangi bir değer yer almaz. |
| Fatura Takip Kodu | Müşteriden İade İrsaliyesi (Sağlam) belgesinin faturalaştırılması durumunda bu alanda bağlı Müşteriden İade Faturası (Sağlam ) belgesinin fatura takip kodu değeri görünür. |
...
| Alan | Açıklama |
| --- | --- |
| Ceza İsk. | İlgili müşteri için ceza iskontosu uygulanması durumunda iskonto seçimi bu alandan yapılır. |
...
| Ürün Sorgulama | Ürünlerin ürün kodu, grup, ek grup(Marka /Mevsim ) , Marka/ Grup ve stok durumuna göre ürünlerin hızlı bir şekilde sorgulandığı ekrandır.(Bu ekran ile ilgili bilgiye ürün Sorgulama Ekranındaki Yardım butonundan ulaşılabilir.) |
| İade Depo Ürünleri | Belgede seçilen deponun türü Bozuk iade deposu ise detayda İade Depo Ürünleri butonuna basıldığında seçilmiş olan depodaki ürünlerin belge detayına otomatik olarak eklendiğini görürüz. |
| Seriden Ürün Girişi | Seri numarasına bağlı olarak ürünlerin detaya eklenmesini için kullanılır. |
...
| İade Nedeni | Seçilen Ürün için iade neden seçimi bu alandan yapılır. Parametrik olarak belge başlıkta veya detayda iade nedeni girilir. |
| isk1 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| isk2 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| isk3 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
