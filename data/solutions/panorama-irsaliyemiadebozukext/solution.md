# İade Irsaliyesi(Bozuk)

_Kaynak: Panorama Kullanım Kılavuzu_

**Menü Adımı:** `Satış ve Alış İşlemleri → Müşteriden İade İşlemleri → İade İrsaliyesi (Bozuk)`

## Ekran Tanımı

Müşteriden İade İrsaliyeleri (Bozuk) bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Müşteriden İade İrsaliyeleri (Bozuk) listelenir.
...
| Satış Temsilcisi | Müşteriden İade İrsaliyesinin (Bozuk) hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Müşteriden İade İrsaliyesi (Bozuk) için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Onay Durumu | Eğer Müşteriden İade İrsaliyesi (Bozuk) için iş akış tanımı var ise Müşteriden İade İrsaliyesi (Bozuk) kaydedildiğinde onay durumu onaylanmadı olarak görünür. Kaydetmiş olduğumuz Müşteriden İade İrsaliyesi (Bozuk) İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Müşteriden İade İrsaliyesi (Bozuk) ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
...
| Sipariş Takip Kodu | Müşteriden İade İrsaliyesi (Bozuk) eğer herhangi bir Müşteriden iade siparişine bağlı olarak oluşturuldu ise Bağlı siparişin Sipariş takip kodu bilgisi bu alana görünür. |
| Fatura Takip Kodu | Müşteriden İade İrsaliyesi (Bozuk) belgesine bağlı Müşteriden İade Faturası(Bozuk) var ise iade faturasının belge kodu bu alanda görünür. |
