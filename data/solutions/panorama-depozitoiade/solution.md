...
**Menü Adımı:** `Satış ve Alış İşlemleri → Müşteriden İade İşlemleri →Depozito İade`

## Ekran Tanımı

Depozito iade Faturaları bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Depozito iade Faturaları listelenir.
...
| Satış Temsilcisi | Depozito iade Faturasının hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Depozito iade Faturası için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Sevk Tarihi | Sevk Tarihi bilgisini gösterir. |
| Açık Kapalı | Belgenin Açık/Kapalı bilgisinin girildiği alandır. |
...
| Kayıt Tipi | Belge detayına eklenen ürünün ürün tipidir, depozito iade faturasında detayda sedece depozito ürünler listelendiği için bu alanda sadece DI veya DS değerleri görünür. |
...
| Giriş Tipi | Depozito İade Faturasının nereden girilmiş olduğunu belirtir. Panoramadan girilen İrsaliyeler için giriş tipi EnroutePanorama, Mobilden girilen irsaliyelerde giriş tipi PanoramaMobile, Ticari Paket aktarımı ile gelen irsaliyelerde giriş tipi Panorama Aktarım olarak görünür. |
| Belge Durumu | Depozito İade Faturasının durumunun ne olduğunu gösterir. Aktif, Pasif, İptal, Bloke, Silindi değerlerini alır. |
| Basım Durumu | Depozito İade Faturasının kaydedildiğinde basım durumu yazdırılmadı olarak görünür. Depozito İade Faturasının yazdırdıktan sonra basım durumu yazdırıldı olarak güncellenir. |
| Aktarım Durumu | Depozito İade Faturasının Ticari pakete aktarılıp aktarılmadığı bilgisini gösterir. Ticari pakete aktarılmamış Depozito İade Faturasının aktarım durumu Aktarılmadı, Ticari Pakete aktarılmış Depozito İade Faturasının aktarım durumu Aktarıldı olarak görünür. |
| Onay Durumu | Eğer Depozito İade Faturası için iş akış tanımı var ise irsaliye kaydedildiğinde onay durumu onaylanmadı olarak görünür. Bu Depozito İade Faturası İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Depozito İade Faturası ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
| Oluşturulma Yeri | Depozito İade Faturasının hangi menüden oluşturulduğunun bilgisinin gösterildiği alandır. |
| Oluşturulma Tarihi | Depozito İade Faturasının hangi tarih ve hangi saatte oluşturulduğunun gösterildiği alandır. |
| İrsaliye Takip Kodu | Depozito iade belgesi herhangi bir belgeye bağlı oluşmuyor. |
| Sipariş Takip Kodu | Depozito iade belgesi herhangi bir belgeye bağlı oluşmuyor. |
| Komisyon TL | Depozito İade Faturasında yer alan ürüne tanımlanmış Kredi kartı komisyonu tanımı var ise yapılan hesaplama sonucu fatura tutarına aktarılan komisyon tutarının gösterildiği alandır. |
| Brüt Tutar | Depozito İade Faturasında yer alan ürünlerin, KDV tutarlarının toplam bilgisidir. |
| İskonto Tutarı | Belgenin tamamına uygulanan iskontonun toplam tutarıdır. Oran ise iskonto tutarının Brüt tutara oranını gösterir. |
...
| Takip Kod | Listelenen ürünlerin takip kodlarını gösterir. Sadece tipi Depozito olan ürünler listelenir. |
| Ürün Adı | Listelenen ürünlerin Adını gösterir. Sadece tipi Depozito olan ürünler listelenir. |
| Ürün Kodu | Listelenen ürünlerin Ürün Kodunu gösterir. Sadece tipi Depozito olan ürünler listelenir. |
...
| Barkod Girişi | Belge detayına eklenecek ürün toplu kod girişi ekranından ürün barkod koduna göre aratılıp eklenmek isteniyor ise Barkod Girişi Seçeneği işaretlenerek Kod araması yapılır. (Sadece tipi Depozito olan ürünler için) |
| Ürün Kod Girişi | Belge detayına eklenecek ürün toplu kod girişi ekranından ürün koduna göre aratılıp eklenmek isteniyor ise Ürün Kod Girişi Seçeneği işaretlenerek Kod araması yapılır. (Sadece tipi Depozito olan ürünler için) |
...
| Kod | Ürünün Barkod değeri, Ürün Kod değeri veya Ağırlıklı Ürün Barkod değerlerinden hangisine göre arama yapılıp eklenmesini istiyor isek yukarıdaki 3 seçenekten biri işaretlendikten sonra ilgili değer bu alana girilir. (Sadece tipi Depozito olan ürünler için) |
...
| Ürün | Belge detayına eklenecek ürün rehberden seçilir. Sadece tipi Depozito olan ürünler listelenir. |
| Depo Mik. | Seçilen ürünün belgede seçilen depodaki miktarını gösterir. |
| Miktar | Seçilen ürünün miktarı girilir. |
| Birim | Seçilen ürün için girilen miktarın hangi birimden verildiği seçilir. Ürün tanımdaki birimleri listelenir. |
...
| İsk5 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| İsk6 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| İsk7 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| İsk8 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |
| İsk9 | Ürün için uygulanan uygulanacak iskonto bilgisidir. Oran ya da tutar değeri olabilir. |


---
_Yol: EnRoute Panorama › Satış ve Alış İşlemleri › Müşteriden İade İşlemleri_
