...
**Menü Adımı:** `Satış ve Alış İşlemleri → Satıcıya İade İşlemleri → İade Faturası`

## Ekran Tanımı

Satıcıya İade Faturaları bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Satıcıya İade Faturaları listelenir.
...
| Satış Temsilcisi | İade Faturasının hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Satıcıya İade Faturası için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Bakiye Dövizi | Belgede farklı döviz türünden ürünlerin iadesinin yapılması durumunda belgenin sonuç alanındaki hesaplamanın hangi döviz tipinden yapılacağının belirtildiği alandır. Rehberde para birimi tanımındaki para birimleri listelenir. |
...
| Sevk Tarihi | Belgedeki ürünlerin sevk tarihi bilgisi girilir. |
| Açık Kapalı | Belgenin Açık/Kapalı bilgisinin girildiği alandır. Ödemenin durumuna göre belirlenir. Ödemesi peşin alınacak ise kapalı seçilebilir. |
...
| İade Nedeni | Satıcıya İade Faturasının İade nedeni seçilir. Parametrik olarak başlıkta ya da detayda sorulur. |
...
| İade Nedeni | Satırda seçilen ürünün iade nedeni bu alandan seçilir. |
| Giriş Tipi | Satıcıya İade Faturasının nereden girilmiş olduğunu belirtir. Panoramadan girilen Satıcıya İade Faturaları için giriş tipi EnroutePanorama, Mobilden girilen Faturalarda giriş tipi PanoramaMobile, Ticari Paket aktarımı ile gelen Faturaların giriş tipi Panorama Aktarım olarak görünür. |
| Belge Durumu | Satıcıya İade Faturasının durumunun ne olduğunu gösterir. Aktif, Pasif, İptal, Bloke, Silindi değerlerini alır. |
| Basım Durumu | Satıcıya İade Faturası kaydedildiğinde basım durumu yazdırılmadı olarak görünür. Belge yazdırdıktan sonra basım durumu yazdırıldı olarak güncellenir. |
| Aktarım Durumu | Satıcıya İade Faturasının Ticari pakete aktarılıp aktarılmadığı bilgisini gösterir. Ticari pakete aktarılmamış Satıcıya İade Faturalarının aktarım durumu aktarılmadı, Ticari Pakete aktarılmış Satıcıya İade Faturalarının aktarım durumu Aktarıldı olarak görünür. |
| Onay Durumu | Eğer Satıcıya İade Faturası için iş akış tanımı var ise Satıcıya İade Faturası kaydedildiğinde onay durumu onaylanmadı olarak görünür. Bu Satıcıya İade Faturasının İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Satıcıya İade Faturaları ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
| Oluşturulma Yeri | Satıcıya İade Faturasının hangi menüden oluşturulduğunun bilgisinin gösterildiği alandır. |
| Oluşturulma Tarihi | Satıcıya İade Faturasının hangi tarih ve hangi saatte oluşturulduğunun gösterildiği alandır. |
| İrsaliye Takip Kodu | İlgili Satıcıya İade Faturasının bağlı Satıcıya İade İrsaliyesi var ise bağlı İrsaliyenin belge kodu değeri görünür. |
| Sipariş Takip Kodu | İlgili Satıcıya İade Faturası bir Satıcıya İade siparişine bağlı ise bağlı olan Siparişin belge kodu değeri görünür. |
...
| İade Nedeni | Seçilen ürünün iade nedeni bu alandan seçilir. Parametrik olarak satırda veya belge başlıkta iade nedeni girilir. |
...
| İsk./ Pro. | Belgede hak edilen satır iskontosunun hediyesinin seçimli olması durumunda hediye seçimi bu alandan yapılır. |
...
---
_Yol: EnRoute Panorama › Satış ve Alış İşlemleri › Satıcıya İade İşlemleri_
