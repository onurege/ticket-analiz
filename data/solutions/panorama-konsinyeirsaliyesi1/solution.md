...
**Menü Adımı:** `Satış ve Alış İşlemleri → Alış İşlemleri →Konsinye İrsaliyesi`
...
| Fatura Takip Kodu | Konsinye Alış İrsaliyesi herhangi bir faturaya bağlı oluşmayacağı için bu alanda herhangi bir değer yer almaz. |
| Sipariş Takip Kodu | Konsinye Alış İrsaliyesi herhangi bir siparişe bağlı oluşmayacağı için bu alanda herhangi bir değer yer almaz. |
