...
**Menü Adımı:** `Satış ve Alış İşlemleri → Müşteriden İade İşlemleri → İade Faturası (Bozuk)`

## Ekran Tanımı

Müşteriden İade Faturaları (Bozuk) bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Müşteriden İade Faturaları (Bozuk) listelenir.
...
| Satış Temsilcisi | Müşteriden İade Faturası (Bozuk) hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Müşteriden İade Faturası (Bozuk) için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Onay Durumu | Eğer Müşteriden İade Faturası (Bozuk) için iş akış tanımı var ise Müşteriden İade Faturası (Bozuk) kaydedildiğinde onay durumu onaylanmadı olarak görünür. Kaydetmiş olduğumuz Müşteriden İade Faturası (Bozuk) İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Müşteriden İade Faturası (Bozuk) ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
...
| Sipariş Takip Kodu | Müşteriden İade Faturası (Bozuk) herhangi bir siparişe bağlı olarak oluşturuldu ise ilgili siparişin belge kodu bu alanda görünür. |
| İrsaliye Takip Kodu | Müşteriden İade Faturası (Bozuk) belgesine bağlı Müşteriden İade İrsaliyesi(Bozuk) var ise iade İrsaliyesinin belge kodu bu alanda görünür. |
