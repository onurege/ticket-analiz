...
**Menü Adımı:** `Satış ve Alış İşlemleri → Alış İşlemleri →Fatura`

## Ekran Tanımı

Alış Faturaları bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Alış Faturaları listelenir.
...
| Hareket Tipi | Alış faturası için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Açık Kapalı | Belgenin Açık/Kapalı bilgisinin girildiği alandır. Ödemenin durumuna göre belirlenir. |
| Özel Kod | Zorunlu bir alan değildir. Özel kod değeri girilebilir. |
| KDV'den Muaf | Seçilen müşteri KDV den muaf ise buradaki seçenek işaretli ve pasif gelir fakat müşteri KDV den muaf değilse buradaki seçenek işaretsiz ve aktif gelir. İstenirse ilgili belge için seçenek işaretlenerek KDV hesaplanmayabilir. |
...
| Geri Kazanım Dahil | Detayda seçilecek olan ürünün geri kazanım hesaplaması yapılacak ise bu seçenek işaretlenir. |
| Üretici Kodu | Üretici kodu rehberi açılır ve burada yapılan seçime bağlı olarak belge detayında seçilmiş olan üreticiye ait ürünler listelenir. |
...
| G.K | Başlıkta Geri Kazanım Dahil seçeneği işaretli ise ve ürünün fiyat tanımında geri kazanım değeri tanımlı ise bu alanda Geri Kazanım Değeri görünür. |
...
| Onay Durumu | Eğer Alış Faturası için iş akış tanımı var ise fatura kaydedildiğinde onay durumu onaylanmadı olarak görünür. Bu Faturanın İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise alış faturası ilk kaydedildiğinde onay durumu onaylandı olarak görünür. |
...
| İrsaliye Takip Kodu | İlgili fatura siparişten ya da irsaliyeden oluşturulmuş ise faturanın bağlı olduğu irsaliyenin belge kodu değeri görünür. |
...
| Brüt Tutar | Faturada yer alan ürünlerin, KDV siz tutarlarının toplam bilgisidir. |
...
| G.K Tutarı | Detaydaki Ürünlere ait geri kazanım tutarı var ise ve başlıktaki Geri Kazanım Dahil seçeneği işaretlenmiş ise detaydaki ürünlerin geri kazanım tutarlarının toplamını gösterir. |
...
| Dövizli G.K Tutarı | Belge detayında farklı para birimlerine ait ürünlerin eklenmesi durumunda, belgenin başlık alanında seçilen bakiye döviz alanındaki para birimi ve döviz kuruna bağlı olarak belgenin Geri Kazanım Tutarını gösterir. |
...
| Kod | Girilen ödemenin kodunu gösterir |
| Yıl | Girilen ödemenin yıl değerini gösterir. |
| Tip | Girilen ödemenin Tipini gösterir.(Nakit, Kredi Kartı gibi ) |
| Tutar | Girilen ödemenin tutar değerini gösterir. |
| Belge No | Girilen ödemenin Belge No değerini gösterir. |
| Makbuz No | Girilen ödemenin Makbuz No değerini gösterir |
| Vade Tarihi | Girilen ödemenin Vade tarihi değerini gösterir. |
| Ödeme Tarihi | Girilen ödemenin Ödeme Tarihi değerini gösterir. |
| Banka | Girilen ödemenin tipine göre banka değeri girilmiş ise banka bilgisini gösterir. |
| Şube | Girilen ödemenin tipine göre şube değeri girilmiş ise şube bilgisini gösterir. |
| Çek No | Girilen ödemenin tipine göre çek no değeri girilmiş ise çek no bilgisini gösterir. |
...
| G.K Tutarı | İlgili Ürün için tanımlı geri kazanım değeri var ise bu alanda görünür. |
| ISK/PRO Bilgileri | Hak edilen ve belgede uygulanacak iskonto ve bu iskontoya bağlı hak edilen hediye seçimleri listelenir. |
| Hediye Bilgileri - Miktar | İskonto bilgileri alanında seçilen hediyenin ilgili belgede ne kadar kazanıldığının bilgisi yer alır. |
| Hediye Bilgileri - Seçilen Miktar | İskonto bilgileri alanında seçilen hediyenin türü ürün grup, ürün ek grup, ürün dinamik grup olması durumunda ekranında sağ tarafında ürünlerin listelendiğini görürüz ve seçmiş olduğumuz ürünlere girilen değerlerin toplamı seçilen miktar alanında görünür. |
| Ürün | İskonto bilgileri alanında seçilen hediyenin türü ürün grup, ürün ek grup, ürün dinamik grup olması durumunda listelenen ürünün ürün kodunu gösterir. |
...
| Alan | Açıklama |
| --- | --- |
| Ödeme | Faturaya ait ödeme girişi yapılır. |
...
| Yenile | Ödeme detay alanındaki listenin yenilenmesi için kullanılan butondur. |
| Yeni | Yeni ödeme girişi için kullanılan butondur. |
| Düzenle | Detayda listelenen ödeme üzerinde değişiklik yapılacak ise düzenle butonuna tıklanarak tahsilat üzerinde değişiklik yapılır. |
| İzle | Detayda listelenen ödeme izle modunda açar. |
| Sil | Detayda listelenen Ödemeyi silmek istediğimizde Sil butonuna tıklanır. |
| Kapat | Ödeme ekranını kapatmak için kullanılır. |
| Tutar | Ödemenin tutar değeri girilir. |
| Makbuz No | Ödemenin Makbuz No değeri girilir. |
| Belge No | Ödemenin belge no değeri girilir. |
| Çek No | Ödemenin tipine göre çek no değeri girilir. |
| Tip | Ödemenin Tipi seçilir.(Nakit, Kredi Kartı gibi ) |
| Vade Tarihi | Ödemenin Vade tarihi değeri girilir. |
| Ödeme Tarihi | Ödemenin Ödeme Tarihi değeri girilir. |
| Banka | Ödemenin tipine göre banka bilgisi girilir. |
| Şube | Ödemenin tipine göre şube bilgisi girilir. |
| İşlem Tipi | Ödemenin tipine göre İşlem tipi değerleri listelenir ve buradan Ödemenin işlem tipi değeri seçilir. |
