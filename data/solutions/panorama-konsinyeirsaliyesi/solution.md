...
**Menü Adımı:** `Satış ve Alış İşlemleri → Satış İşlemleri →Konsinye İrsaliyesi`

## Ekran Tanımı

Konsinye İrsaliyeleri bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Konsinye İrsaliyeleri listelenir.
...
| Satış Temsilcisi | Konsinye İrsaliyesinin hangi satış temsilcisi tarafından girildiğini gösteren alandır. Yukarıda seçilen müşteri bir temsilcisinin rutuna bağlı ise müşteri seçiminden sonra Satış Temsilcisi otomatik olarak gelir. Zorunlu bir alandır. |
| Hareket Tipi | Konsinye İrsaliyesi için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Sevk Tarihi | Konsinye irsaliyesindeki ürünlerin sevk edileceği tarih bilgisi girilir. |
...
| Onay Durumu | Eğer Konsinye İrsaliyesi için iş akış tanımı var ise Konsinye İrsaliyesi kaydedildiğinde onay durumu onaylanmadı olarak görünür. Kaydetmiş olduğumuz Konsinye İrsaliyesinin İş akış onaydan onaylanması durumunda Belgenin Onay durumu onaylandı görünür. Fakat iş akış tanımı yok ise Konsinye İrsaliyesi ilk kaydedildiğinde onay durumu onaylandı olarak görünür. Fakat Konsinye İrsaliyesi için iş akış tanımı zaten yapılamadığı için belge kaydedildiğinde onaylandı olarak görünür. |
| Yükleme Kod / Plaka | Konsinye Satış İrsaliyesi yüklemeye dahil olmaz bu yüzden bu alanda her hangi bir değer yer almaz. |
...
| Fatura Takip Kodu | Konsinye Satış İrsaliyesi herhangi bir faturaya bağlı oluşmayacağı için bu alanda herhangi bir değer yer almaz. |
| Sipariş Takip Kodu | Konsinye Satış İrsaliyesi herhangi bir siparişe bağlı oluşmayacağı için bu alanda herhangi bir değer yer almaz. |
| Komisyon TL | Komisyon tutarının gösterildiği alandır. |
| Toplama Durumu | Mobilden girilen belge depocu terminaline düşüyor ve depocu tarafından yapılan işlemin sonucu ile ilgili bilgi bu alandan görülür. |
| Brüt Tutar | Belgede yer alan ürünlerin, KDV tutarlarının toplam bilgisidir. |
...
| Depocuya Gönder | Belgedeki ürünlerin depocu tarafından toplanıp onaylanması için bu parametre işaretlenir. |
| Kısmi Toplama | Belgedeki ürünlerin kısmi olarak toplanması için bu parametre işaretlenir. |
...
| Alan | Açıklama |
| --- | --- |
| Belge Toplama | Panorama’dan girilen belgelerin direkt olarak Depocu el terminaline gönderilebilmesi ve depoda ilgili belgelerin toplaması buradan yapılır. |
...
| Parçalı Vade | Parçalı vade girişi bu adımdan yapılır.(fakat Konsinye İrsaliyede parçalı vade girilmez sadece faturada girilir.) |
