...
**Menü Adımı:** `Satış ve Alış İşlemleri → Alış İşlemleri → İrsaliye`

## Ekran Tanımı

Alış İrsaliyeleri bu ekrandan girilir. Öncelikle ekrana, sisteme daha önceden girilmiş olan Alış İrsaliyeleri listelenir.
...
| Hareket Tipi | Alış İrsaliyesi için tanımlanan hareket tipinin seçildiği alandır. Zorunlu bir alandır. |
...
| Alan | Açıklama |
| --- | --- |
| Ödeme | İrsaliyeye ait ödeme girişi yapılır. |
...
| Düzenle | Detayda listelenen ödeme kayıtları üzerinde değişiklik yapılacak ise düzenle butonuna tıklanarak ödeme kaydı üzerinde değişiklik yapılır. |
| İzle | Detayda listelenen ödeme kaydını izle modunda açar. |
